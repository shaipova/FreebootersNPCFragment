...
import com.example.freebootersnpcfragment.databinding.FragmentHeritageBinding
        ...
        binding.passDataButton.setOnClickListener { view: View ->
            if (radioChecked() != "something wrong") {
                view.findNavController().navigate(
                        HeritageFragmentDirections.actionHeritageFragmentToAlingmentFragment(npc)
                )
            }
